...
export default function BlogCard({
  ...
  return (
    <article
      ...
      } ${featured ? "lg:aspect-[2/1] lg:flex lg:flex-col" : ""}`}
      style={cardStyle}
    ...
    >
      ...
      <div
        className={`relative overflow-hidden ${
          featured ? "bg-accent" : "bg-gradient-to-br from-gray-50 to-gray-100"
        } ${blogId ? "blog-image" : ""} ${
          featured ? "aspect-[5/3] lg:aspect-[3/2]" : "aspect-[5/3]"
        }`}
      >
        {!featured && (
          <Image
      ...
      {/* Content */}
      <div className={`p-6 ${featured ? "lg:flex-1 lg:flex lg:flex-col" : ""}`}>
