      ...
      <div className="relative container mx-auto h-full px-5 sm:px-8 flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-20">
        ...
        <div className="relative z-10 max-w-2xl text-center lg:text-left">
          ...
          <p className="mt-4 text-base sm:text-lg lg:text-xl text-white/80 leading-relaxed animate-fade-in-delay-1 max-w-xl mx-auto lg:mx-0">
            Reflects our commitment to transforming every ride through
            engineering excellence — crafted with precision, built for safety,
            and designed for luxury to deliver a truly seamless passenger
            experience.
          </p>
        ...
        <aside className="hidden lg:flex flex-col w-full max-w-sm rounded-3xl bg-white/10 backdrop-blur-2xl border border-white/20 p-8 shadow-[0_0_60px_rgba(0,255,163,0.15)] text-white animate-fade-in-delay-3">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-white/70">
                Quick response — design & installation experts
              </p>
            </div>
          ...
          <div className="mt-5 grid gap-3">
            ...
            <a
              ...
              className="mt-2 inline-flex items-center justify-center gap-2 rounded-xl bg-accent text-black font-semibold shadow-lg shadow-accent/20 hover:shadow-accent/40 hover:scale-105 transition-all duration-300 px-6 py-3 text-sm"
            >
