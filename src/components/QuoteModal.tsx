                        ...
                        <div className="relative">
                          <span className="pointer-events-none absolute left-3 top-1/2 -translate-y-1/2 z-20 text-[var(--color-charcoal)]">
                            <svg
                              ...
                              fill="none"
                              xmlns="http://www.w3.org/2000/svg"
                              className="text-[var(--color-charcoal)] sm:w-[18px] sm:h-[18px]"
                      ...
                      <div className="relative">
                        ...
                        <div className="relative">
                          <span className="pointer-events-none absolute left-3 top-1/2 -translate-y-1/2 z-20 text-[var(--color-charcoal)]">
                            ...
                            >
                              <path
                                d="M22 16.92v3a2 2 0 0 1-2.18 2 19.86 19.86 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6A19.86 19.86 0 0 1 2.08 4.18 2 2 0 0 1 4 2h3a2 2 0 0 1 2 1.72c.12 1.05.37 2.07.75 3.03a2 2 0 0 1-.45 2.11L8.09 11.91a16 16 0 0 0 6 6l1.05-1.05a2 2 0 0 1 2.11-.45c.96.38 1.98.63 3.03.75A2 2 0 0 1 22 16.92z"
                                stroke="currentColor"
                                strokeWidth="2"
                                strokeLinecap="round"
                                strokeLinejoin="round"
                      ...
                      <div className="relative">
                        ...
                        <div className="relative">
                          ...
                          >
                            ...
                            <option value="Stiltiz Homelifts">
                              Stiltiz Homelifts
                            </option>
                            <option value="Home Elevators">
                              Home Elevators
                            </option>
                            ...
                            <option value="Goods Elevators">
                              Goods Elevators
                            </option>
                            <option value="Hospital Elevators">
                              Hospital Elevators
                            </option>
